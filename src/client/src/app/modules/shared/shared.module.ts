...
import {
  ...
  OfflineCardComponent, FullPageModalComponent
} from './components';
import {
...
@NgModule({
  ...
  declarations: [AppLoaderComponent, AnnouncementInboxCardComponent, DateFormatPipe, PageSectionComponent,
    ...
    InstallAppComponent, LockInfoPopupComponent, ContentDirectionDirective, OfflineCardComponent,
  ...
  exports: [AppLoaderComponent, AnnouncementInboxCardComponent, DateFormatPipe, DateFilterXtimeAgoPipe,
    ...
    CustomMultiSelectComponent, InstallAppComponent, LockInfoPopupComponent, ContentDirectionDirective, HighlightTextDirective,
    FullPageModalComponent, AccountMergeModalComponent]
})
